...
<form class="cart grouped_form w-100 d-flex justify-content-between flex-wrap" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	<!-- <table cellspacing="0" class="woocommerce-grouped-product-list group_table">
		<tbody> -->
			...
			<?php do_action( 'woocommerce_grouped_product_list_before', $grouped_product_columns, $quantites_required, $product ); ?>
			...
			<?php do_action( 'woocommerce_grouped_product_list_after', $grouped_product_columns, $quantites_required, $product ); ?>
		<!-- </tbody>
	</table> -->
