				...
				<!-- <ul id="shipping_method" class="woocommerce-shipping-methods"> -->
					<?php foreach ( $available_methods as $method ) : ?>
						<div class="form-check mt-3">
							...
							printf( '<label for="shipping_method_%1$s_%2$s" class="form-check-label">%3$s</label>', $index, esc_attr( sanitize_title( $method->id ) ), wc_cart_totals_shipping_method_label( $method ) ); // WPCS: XSS ok.
