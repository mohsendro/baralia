                ...
                <ul class="navbar-nav align-items-center">
                        ...
                        <ul class="main-menu mega-container">
                            <li class="main-menu-sub-active-li">
                                ...
                                <ul class="main-menu-sub back-menu"
                                    style=" background: #fff url('<?php echo TYPEROCKET_DIR_URL; ?>resources/assets/img/509-5092096_offering-high-quality-mobile-repair-service-main-image_prev_ui.png') no-repeat;">
                            ...
                            <li><a href=""><i class="bi bi-tablet"></i> تبلت</a>
                                <ul class="main-menu-sub back-menu"
                                    style=" background: #fff url('<?php echo TYPEROCKET_DIR_URL; ?>resources/assets/img/tablet-menu.png') no-repeat;">
                                    <li><a class="title my-flex-baseline" href="">برند های مختلف
                                            تبلت</a>
                                    </li>
                            ...
                            <li><a href=""><i class="bi bi-shield"></i>آنتی ویروس</a>
                                <ul class="main-menu-sub back-menu"
                                    style=" background: #fff url('<?php echo TYPEROCKET_DIR_URL; ?>resources/assets/img/EAV.png') no-repeat;">
                            ...
                            <li><a href=""><i class="bi bi-laptop"></i>لبتاپ</a>
                                <ul class="main-menu-sub back-menu"
                                    style=" background: #fff url('<?php echo TYPEROCKET_DIR_URL; ?>resources/assets/img/labtop.png') no-repeat;">
                                    <li><a class="title my-flex-baseline" href="">برند های مختلف
                                            لبتاپ</a>
                                    </li>
                            ...
                            <li><a href=""><i class="bi bi-tag"></i>پر فروش ترین ها</a>
                                <ul class="main-menu-sub back-menu"
                                    style=" background: #fff url('<?php echo TYPEROCKET_DIR_URL; ?>resources/assets/img/top-sales.jpeg') no-repeat;">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="list-unstyled shadow-lg back-menu sub-menu mega-container"
                            ...
                            <li><a class="title" href="">براساس رده بندی </a>
                            </li>
                            ...
                            <li><a class="title" href="">براساس کشور </a></li>
                            ...
                            <li><a class="title" href="">براساس رنگ</a></li>
                            <li><a href="">قرمز</a></li>
